...
<Columns cols="3">
  ...
  <Card title="API Keys" href="/authentication#creating-an-api-key" icon="key" horizontal="false">
    User-scoped keys for server-side or script access. Full access to user resources.
  </Card>

  <Card title="File Upload" href="/quickstart#4-upload-a-file-s3-presigned-url" icon="upload" horizontal="false">
