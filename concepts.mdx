...
Ctxfy organizes AI context in a hierarchical model: **Spaces** → **Collections** → **Sources** → **Artifacts**. Upload raw input (conversations, documents, files), extract structured context and artifacts, and use them across projects.
