...
When creating a source, you can pass `postback_url` inside `instructions` to receive an HTTP POST when processing completes. See [Postbacks](/help-center/guides/postbacks) for details.
