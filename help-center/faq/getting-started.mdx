...
## Where is the full API spec?See the [API Reference](/authentication) tab and the OpenAPI specification (`openapi.yaml`). All endpoints under `/api/v1` are documented there.
